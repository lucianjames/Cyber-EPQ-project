...
\textbf{Technically, the salt can be found, but....}
Something something discrete log problem. Calculating $log_CR$ is very hard given big numbers with the right features.
