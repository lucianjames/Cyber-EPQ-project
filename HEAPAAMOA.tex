...
Not sure where I got this from, it is a set of rules for use during rule-based password cracking. It consists of 229 rules which modify input password guesses.
\end{itemize}
...
Comparison with \cite{pearman2017let}!!
...
This indicates that pwned-passwords-ntlm-ordered-by-hash-v7 was probably made using this dataset, as 93\% recovery is not very realistic.
...
something something \cite{mayer2018addressing}.
