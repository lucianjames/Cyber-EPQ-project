...
\begin{proof}
$$S_2=(g^a((g^{H(s,P_1)})^u))^b $$
$$=(g^a(g^{u(H(s,P_1))}))^b$$
$$=(g^{a+u(H(s,P_1))})^b$$
$$=g^{b(a+u(H(s,P_1)))}$$
$$=g^{ba+bu(H(S,P_1))}$$

$$S_1=(g^{H(s,P_1)}+g^b-g^{H(s,P_2)})^{a+u(H(s,P_2))}$$
$$P_1=P_2 \Longrightarrow g^{H(s,P_1)}-g^{H(s,P_2)}=0 \therefore S_1=(g^b)^{a+u(H(s,P_2))}$$
$$=g^{b(a+u(H(s,P_2)))}$$
$$=g^{ba+bu(H(S,P_2))}$$

$$S_1=S_2 \Longrightarrow (g^{H(s,P_1)}+g^b-g^{H(s,P_2)})^{a+u(H(s,P_2))}=(g^b)^{a+u(H(s,P_2))}$$
$$S_1=S_2 \Longrightarrow g^{ba+bu(H(S,P_1))}=g^{ba+bu(H(S,P_2))} \Longrightarrow P_1=P_2$$
\end{proof}
