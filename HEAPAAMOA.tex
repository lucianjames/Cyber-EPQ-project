...
An example of a protocol which allows for this kind of encryption is TLS.
...
PAKE protocols are sometimes used when public key infrastructure is unavailable (digital certificates).
