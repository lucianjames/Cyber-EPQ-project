...
\end{quote}
Making a comparison between this information, and a similar analysis of the password dictionaries listed in \ref{datasets} makes it possible to determine how realistic these dictionaries are.
