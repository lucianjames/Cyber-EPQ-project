...
\item It is OK to reuse passwords from user accounts that you log in frequently for different user accounts.
\item Security-wise, it is better to write passwords down and keep them in a secure location than to reuse passwords for different user accounts.
\item Notes of passwords must always be stored in a secure location.
\item Passwords should be changed frequently.
\item Storing passwords in the browser is the same as storing passwords in a password manager.
\end{itemize}
