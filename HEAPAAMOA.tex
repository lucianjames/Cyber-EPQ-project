...
When paired with well educated users, password authentication can be considered very secure. The efficacy of password-based authentication systems depends greatly on those using the systems, great responsibility is placed on the users to keep their own accounts safe.
